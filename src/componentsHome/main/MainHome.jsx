    ...
    <main className='backgorundHome'>
          ...
          <div className='col'>
            <div className='container'>
              <div className='row'>
                ...
                <div className='col'>
                  <div className='row'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="fff" class="bi bi-currency-exchange" viewBox="0 0 16 16">
                ...
                <div className='col'>
                  <div className='row text-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="fff" class="bi bi-battery-charging" viewBox="0 0 16 16">
      ...
      <div className='home-bg mt-5'>
          ...
          <div className='row text-white mt-5'>
            <div className='col text-center'><p>The distributed sensors, collect, and encrypt the data with a private key that only the client knows.</p></div>
            ...
            <div className='col text-center'><p>The network server, with a private key, can decrypt the content and show the data for analysis.</p></div>
          </div>
          </div>
        </div>
    </main>
