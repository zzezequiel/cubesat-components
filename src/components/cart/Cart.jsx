      ...
      <div>
        ...
        {cartItems.length === 0 ? (
          ...
          <div>
            ...
            <button onClick={() => deleteAllCart(cartItems)} className="btn btn-danger p-2 pt-1 px-5 "><svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-x-octagon-fill" viewBox="0 0 16 16">
